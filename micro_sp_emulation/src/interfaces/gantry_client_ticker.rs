...
pub async fn gantry_client_ticker(
    ...
    loop {
        ...
        let gantry_command_command =
            state.get_string_or_default_to_unknown( "gantry_command_command", &log_target);
        let gantry_speed_command =
            state.get_float_or_default_to_zero( "gantry_speed_command", &log_target);
        let gantry_position_command =
            state.get_string_or_default_to_unknown( "gantry_position_command", &log_target);
        ...
        let emulate_execution_time =
            state.get_int_or_default_to_zero( "gantry_emulate_execution_time", &log_target);
        let emulated_execution_time =
            state.get_int_or_default_to_zero( "gantry_emulated_execution_time", &log_target);
        let emulate_failure_rate =
            state.get_int_or_default_to_zero( "gantry_emulate_failure_rate", &log_target);
        let emulated_failure_rate =
            state.get_int_or_default_to_zero( "gantry_emulated_failure_rate", &log_target);
        let emulate_failure_cause =
            state.get_int_or_default_to_zero( "gantry_emulate_failure_cause", &log_target);
        let emulated_failure_cause_sp_value =
            state.get_array_or_default_to_empty( "gantry_emulated_failure_cause", &log_target);
